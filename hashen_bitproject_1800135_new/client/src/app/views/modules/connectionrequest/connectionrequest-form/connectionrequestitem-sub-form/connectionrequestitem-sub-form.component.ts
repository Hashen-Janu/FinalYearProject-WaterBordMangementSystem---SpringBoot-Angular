...
@Component({
  selector: 'app-connectionrequestitem-sub-form',
  templateUrl: './connectionrequestitem-sub-form.component.html',
  styleUrls: ['./connectionrequestitem-sub-form.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ConnectionrequestitemSubFormComponent),
      multi: true
    }, {
...
export class ConnectionrequestitemSubFormComponent extends AbstractSubFormComponent<Connectionrequestitem> implements OnInit{
